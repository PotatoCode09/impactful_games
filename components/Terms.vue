    ...
    <div class="terms-content">
      ...
      <div id="introduction" class="terms-section">
        ...
        <p>
          ...
          multiple genres. By using our platform, you agree to comply with these
          Terms of Service ("ToS"). If you do not agree, please do not use the
          platform.
        </p>
        <p>
          These ToS govern your access to and use of the platform and include
          provisions related to data privacy, as required under the General Data
          Protection Regulation (GDPR) and the Data Privacy Act of 2012.
        </p>
      </div>
      ...
      <div id="registration" class="terms-section">
        ...
        <p>
          ...
          provide accurate and up-to-date information during the registration
          process and to update your information as necessary.
        </p>
        <p>
          We collect personal data such as your name, email address, and account
          preferences when you register. This data is necessary for providing
          our services, and we will handle it in accordance with applicable
          privacy laws, including the GDPR and the Data Privacy Act of 2012.
        </p>
      </div>
      ...
      <div id="rights" class="terms-section">
        ...
        <ul class="terms-list">
          <li>Access, modify, and delete your personal data</li>
          <li>Withdraw consent at any time by contacting us</li>
          <li>
            Request that we stop processing your data for certain purposes,
            including marketing
          </li>
      ...
      <div id="data" class="terms-section">
        ...
        <ul class="terms-list">
          ...
          <li>Interaction Data: Ratings, comments, and wishlist entries</li>
          <li>
            Technical Data: IP address, device information, and usage patterns
          </li>
        </ul>
        <p>We process this data to:</p>
        <ul class="terms-list">
          <li>
            Provide the platform's core features (e.g., game rating, comments,
            and wishlist)
          </li>
          <li>Improve our services and user experience</li>
          <li>Communicate with users about updates and relevant features</li>
          <li>Comply with legal obligations and user requests</li>
        </ul>
      </div>
      ...
      <div id="security" class="terms-section">
        ...
        <p>
          ...
          transmission over the internet is 100% secure. By using the platform,
          you acknowledge the inherent risks associated with online data
          transmission.
        </p>
      </div>
      ...
      <div id="responsibilities" class="terms-section">
        ...
        <ul class="terms-list">
          ...
          <li>
            Violating the rights of other users, including harassment or
            spamming
          </li>
          <li>Using the platform for unauthorized or unlawful purposes</li>
        </ul>
      </div>
      ...
      <div id="termination" class="terms-section">
        ...
        <p>
          ...
          deletion, we will retain your data only as required by law.
        </p>
      </div>
      ...
      <div id="compliance" class="terms-section">
        ...
        <p>
          If you are a resident of the European Union, your personal data is
          processed in accordance with the General Data Protection Regulation
          (GDPR). You have the right to request access to, correction of, or
          deletion of your personal data, and the right to object to processing.
        </p>
        <p>
          If you are a resident of the Philippines, we comply with the Data
          Privacy Act of 2012 and the regulations set by the National Privacy
          Commission. You have the right to access, correct, or erase your
          personal data and to object to its processing.
        </p>
      </div>
      ...
      <div id="changes" class="terms-section">
        ...
        <p>
          ...
          platform after changes constitutes your acceptance of the updated ToS.
        </p>
      </div>
